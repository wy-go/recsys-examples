...
Per-GPU, per-step (8 layers), rank0's fastest step, for both (A) and (B) ([(A) = upstream's exact §2.3 method](https://github.com/NVIDIA/recsys-examples/blob/main/examples/hstu/training/benchmark/PERF_ANALYSIS.md#23-hstu-cutlass-attention-tflops-and-mfu)).
